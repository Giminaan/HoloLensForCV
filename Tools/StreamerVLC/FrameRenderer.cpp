...
void FrameRenderer::PseudoColorForDepth(int pixelWidth, byte* inputRowBytes, byte* outputRowBytes, float depthScale, float minReliableDepth, float maxReliableDepth)
{
...
Windows::Graphics::Imaging::SoftwareBitmap ^ SensorStreaming::FrameRenderer::ConvertDepthToDisplayable(Windows::Graphics::Imaging::SoftwareBitmap ^ input)
{
	//throw ref new Platform::NotImplementedException();

	// TODO: insert return statement here
	if (input->BitmapPixelFormat == BitmapPixelFormat::Gray16)
	{
		...
		// Long Throw ToF Depth
		//minReliableDepth = 0.5f;
		//maxReliableDepth = 4.0f;

		// Short Throw ToF Depth
		minReliableDepth = 0.2f;
		maxReliableDepth = 1.0f;

		return TransformBitmap(input, std::bind(&PseudoColorForDepth, _1, _2, _3, depthScale, minReliableDepth, maxReliableDepth));
	}
	else
	{
